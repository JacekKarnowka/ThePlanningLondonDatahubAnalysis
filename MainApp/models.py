...
for name in columns:
    TenureData.add_to_class(name, models.TextField(default="-", null=True))
...
for name in columns:
    AllApps.add_to_class(name, models.TextField(default="-", null=True))
