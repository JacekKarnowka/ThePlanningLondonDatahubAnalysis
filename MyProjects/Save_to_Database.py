...
def save_to_database(dictionary):
    ...
    Unit_type_Flat_Apartment_Maisonette = dictionary['Unit_type_Flat_Apartment_Maisonette'],
    ...
    Development_type_Change_of_Use = dictionary['Development_type_Change_of_Use'],
     ...
     #Units types
    floorspace_detail_actual_completion_date = dictionary['floorspace_detail_actual_completion_date'],
    ...
    floorspace_detail_superseded_by_lpa_app_no = dictionary['floorspace_detail_superseded_by_lpa_app_no'],
    floorspace_detail_superseded_date = dictionary['floorspace_detail_superseded_date'],
